function Dec = DecodingAnalysis1D(Nav, Srep, decparams)
% Dec = DecodingAnalysis1D(Nav, Srep, decparams)
% Decoding a single behavioral variables from a set of neuron's spike 
% trains.
%
%
% Inputs:
%   Nav: Structure containing dependent variables (X).
...
%   - mapX: Place field maps for each cell (ncells x nXbins).
%   - mapX_cv: Cross-validated place field maps (ncells x nXbins x k-fold).
...
%
% See Also:
%   ComputeBayesMAP, crossvalPartition, GaussianSmooth, Compute1DMap
%
