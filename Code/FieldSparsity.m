...
% FieldSparsity Compute the sparsity index of a tuning curve.
%
% sparsityIndex = FieldSparsity(t, o) computes the selectivity of a tuning curve t
...
%
% USAGE:
% sparsityIndex = FieldSparsity(t, o);
%
%
