...
%   a Poisson distribution. Different models are compared
%   (position-only, speed-only, position x speed) using log likelihood ratio tests
%   to determine the best model for each cell.
%
% Inputs:
