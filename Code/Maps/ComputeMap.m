...
%
%
%   ComputeMap efficiently computes a two-dimensional map by accumulating
...
%
%   INPUTS:
%   Xd:         The binned independent variable along the X-axis.  If empty
%   computes a 1D map along Y
%   Yd:         The binned independent variable along the Y-axis. If empty
%   computes a 1D map along X
